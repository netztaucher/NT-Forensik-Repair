...
#  Vorlage: Marco Neubers Apple-Mail-Fassung (angermünder-fc.de).
...
#     domain          Domain des Kunden (z.B. "angermünder-fc.de")
...
DEMO = {
    "domain": "angermünder-fc.de",
    "has_shop": True,
    "affected_area": "Shop-Bereich",
    "finding_summary": "mehrere versteckte Hintertüren",
    "timeframe": "erst in diesem Sommer",
    "recipients": [
        {"name": "", "email": "zicoafc@aol.com"},
        {"name": "Herr Gerd Schwichtenberg", "email": "g.schwichtenberg@angermuender-fc.de"},
    ],
}
